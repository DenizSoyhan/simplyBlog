...
<p className="articleText" dangerouslySetInnerHTML={{ __html: 'I went to the Youtube video. Stopped at the right time and right click to \"Copy Video URL at the current time\". And use the \"Add Youtube Video\" button in the generator to add it to my article. ' }} />
