...
function ArticleGenerator() {
  ...
  function generateJSXFile() {
    ...
    const jsxContent = `export default function ${fileName}() {
      return (
          ...
          ${previewContent
            ...
            .map((item) => {
              if (item.startsWith("[Image:")) {
                const imagePath = item.slice(7, -1); // Remove '[Image: ' and ']'
              ...
              if (item.startsWith("[Video:")) {
                const videoUrl = item.slice(8, -1); // Remove '[Video: ' and ']'
  ...
  return (
    <div className="generatorContainer">
      ...
      <input
        type="text"
        placeholder="File Name (e.g., Article1)"
        value={fileName}
